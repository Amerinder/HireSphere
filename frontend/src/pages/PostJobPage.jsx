      ...
      <form onSubmit={handleSubmit(onSubmit)} className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2">
          ...
          <label className="block sm:col-span-2">
            <span className="text-sm font-medium text-slate-700">Last date to apply</span>
            <input className="mt-2 h-11 w-full rounded-md border border-slate-300 px-3" type="date" {...register('application_deadline')} />
          </label>
        </div>
